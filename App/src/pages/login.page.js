...
import { ScrollView, Text, ImageBackground, StyleSheet,View , TextInput, TouchableOpacity } from "react-native";
  ...
  return (
    <ScrollView>
      ...
      >
        ...
        <Text style={{fontSize:20 , color:"#C4C4C6",marginTop:10}}>Nice to meet you again</Text>
        </View>
        ...
        <View style={styles.login}>
          ...
          <Text style={{color:"black", fontSize:17,marginBottom:10}}>Username</Text>
           ...
           />
          <Text style={{color:"black", fontSize:17,marginBottom:10}}>Password</Text>
           <TextInput
           style={styles.textinput}
           placeholder="Enter Password"
           />
           
           <View style={{padding:0 ,flexDirection: "row" , alignItems:"center",marginTop:10}}>
           <View style={styles.button}>
             <TouchableOpacity styles={styles.loginBtn}> 
                <Text style={{color:"#fff", fontSize:20,textAlign:"center"}}>Sign in</Text>
             </TouchableOpacity>
           </View>

           <TouchableOpacity >
           <Text style={{marginLeft:110, color:"blue" , fontSize:14 , textDecorationLine: 'underline'}}>Forgot password?</Text>
           </TouchableOpacity>
